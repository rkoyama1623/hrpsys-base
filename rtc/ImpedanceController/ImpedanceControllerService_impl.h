...
public:
  ...
  CORBA::Boolean setImpedanceMode(OpenHRP::ImpedanceControllerService::ControllerMode i_mode_);
  CORBA::Boolean getImpedanceMode(OpenHRP::ImpedanceControllerService::ControllerMode_out i_mode_);
