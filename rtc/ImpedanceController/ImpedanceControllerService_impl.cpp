...
CORBA::Boolean ImpedanceControllerService_impl::setImpedanceControllerParamIn(const char *i_name_, const OpenHRP::ImpedanceControllerService::impedanceParam &i_param_)
{
  return m_impedance->setImpedanceControllerParamIn(std::string(i_name_), i_param_);
}

CORBA::Boolean ImpedanceControllerService_impl::getImpedanceControllerParamIn(const char *i_name_, OpenHRP::ImpedanceControllerService::impedanceParam_out i_param_)
{
  i_param_ = new OpenHRP::ImpedanceControllerService::impedanceParam();
  i_param_->force_gain.length(3);
  i_param_->moment_gain.length(3);
